...
<section>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
    ...
    {/* LEFT FEATURED CARD */}
    <div className="lg:col-span-2 rounded-2xl border border-gray-200 bg-white p-5 sm:p-6 flex flex-col justify-between relative overflow-hidden shadow-sm group">

      {/* background circle */}
      <div className="absolute right-4 sm:right-6 top-6 sm:top-1/2 sm:-translate-y-1/2 h-20 w-20 sm:h-28 sm:w-28 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center select-none shadow-sm pointer-events-none group-hover:scale-105 transition-transform">
        <span className="text-4xl sm:text-6xl font-black text-indigo-400">
          G
        </span>
      </div>

      <div className="z-10">
        <div className="flex items-start sm:items-center gap-3 mb-3.5">
          <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl border border-gray-200 p-1.5 flex items-center justify-center shadow-sm">
            <img
          ...
          <div>
            <h3 className="text-base sm:text-lg font-black text-gray-900 leading-tight group-hover:text-rose-500 transition-colors">
              Glean
            </h3>
            <span className="text-[10px] font-bold text-indigo-600 bg-indigo-50 border border-indigo-200 px-2 py-0.5 rounded-full mt-1 inline-block">
              AI Search
            </span>
          </div>
        </div>

        <p className="text-xs text-gray-500 max-w-xs leading-relaxed mt-3 sm:mt-4">
          Enterprise search engine for all your workplace data. Finds
          information across your company in seconds.
        </p>
      </div>

      <div className="flex flex-wrap gap-2 sm:gap-4 text-[10px] text-gray-400 pt-4 sm:pt-5 mt-5 sm:mt-6 border-t border-gray-100 z-10 font-semibold">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4 flex flex-col justify-between shadow-sm hover:border-rose-300 hover:shadow-md transition-all group">
        <div>
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <div className="h-8 w-8 sm:h-9 sm:w-9 rounded-xl border border-gray-100 bg-gray-50 flex items-center justify-center p-1.5 shadow-sm">
              <img
          ...
          <h4 className="text-xs font-black text-gray-800 group-hover:text-rose-500 transition-colors">
        ...
        <div className="text-[9px] text-gray-400 font-semibold pt-3 mt-4 border-t border-gray-100">
